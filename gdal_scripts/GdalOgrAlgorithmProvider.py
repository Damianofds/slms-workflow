...
from warp_slms import warp_slms
from rgb2pct import rgb2pct
from translate import translate
from translate_slms import translate_slms
from pct2rgb import pct2rgb
from merge import merge
from buildvrt import buildvrt
from polygonize import polygonize
from gdaladdo import gdaladdo
from gdaladdo_slms import gdaladdo_slms
...
from ogr2ogrtopostgislist_slms import Ogr2OgrToPostGisListSLMS
from ogr2ogrtopostgislistappend_slms import Ogr2OgrToPostGisListAppendSLMS
...
class GdalOgrAlgorithmProvider(AlgorithmProvider):
    ...
    def createAlgsList(self):
        ...
        self.preloadedAlgs = [nearblack(), information(), warp(), translate(),
							  ...
							  # ------ Custom SLMS stuff --------
							  Ogr2OgrToPostGisListSLMS(), Ogr2OgrToPostGisListAppendSLMS(), translate_slms(), gdaladdo_slms(), warp_slms(),
                              ]
