...
class Ogr2OgrToPostGisListAppendSLMS(GdalAlgorithm):
    ...
    def commandLineName(self):
        return "gdalogr:slms-shp2PostGIS-append"
    ...
    def defineCharacteristics(self):
        self.name, self.i18n_name = self.trAlgorithm('SLMS - Import Vector timeseries instance into PostGIS (APPEND MODE)')
    ...
    def getConsoleCommands(self):
        ...
        overwrite = False #self.getParameterValue(self.OVERWRITE)
        append = True #self.getParameterValue(self.APPEND)
